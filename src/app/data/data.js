...
export const educationData = [
  ...
  {
    title: "Calaca Senior High School",
    subtitle: "Madalunot, Calaca City, Batangas",
    yearRange: "2019 — 2021",
  },
];
...
export const expData = [
  {
    ...
    description: [
      "Collaborated on the development of a Public Dashboard for the university, resulting in improved organization and viewing of research projects and related activities.",
      "Utilized skills in software engineering, web development, and project management to contribute to the successful completion of the project.",
    ],
  ...
  },
  {
    ...
    companyName: "Center for Technopreneurship and Innovation",
    description: [
      "Contributed to the design and implementation of a SOS application that enhances user safety by sending the user's current location and a taken picture to the admin.",
      "Leveraging both frontend and backend technologies, ensured seamless integration and real-time data transmission, providing an efficient and reliable solution for emergency situations.",
      "This project involved working with geolocation services, image handling, and secure data communication to create a robust and user-friendly application.",
    ],
  },
];
...
export const projectData = [
  {
    ...
    links: [
      {
        label: "jericho-millena.github.io/PublicD",
        href: "https://jericho-millena.github.io/PublicD/",
        type: "primary",
        iconPath: "M13.5 4.5h6m0 0v6m0-6L10.5 13.5",
      },
      {
        label: "github.com/jericho-millena/PublicD",
        href: "https://github.com/jericho-millena/PublicD",
        type: "secondary",
        iconPath:
          "M12 2C6.48 2 2 6.48 2 12c0 4.42 2.87 8.17 6.84 9.49.5.09.66-.21.66-.47 0-.23-.01-.85-.01-1.66-2.78.6-3.37-1.34-3.37-1.34-.45-1.16-1.1-1.47-1.1-1.47-.9-.62.07-.61.07-.61 1 .07 1.52 1.04 1.52 1.04.88 1.5 2.31 1.07 2.88.82.09-.64.35-1.07.64-1.32-2.22-.25-4.56-1.11-4.56-4.92 0-1.09.39-1.99 1.03-2.69-.1-.26-.45-1.29.1-2.68 0 0 .84-.27 2.75 1.02A9.56 9.56 1 0 1 12 7.57c.85.004 1.71.115 2.52.34 1.91-1.29 2.75-1.02 2.75-1.02.55 1.39.2 2.42.1 2.68.64.7 1.03 1.6 1.03 2.69 0 3.82-2.35 4.67-4.58 4.91.36.31.68.92.68 1.86 0 1.34-.01 2.42-.01 2.74 0 .26.17.57.67.47A10.02 10.02 0 0 0 22 12c0-5.52-4.48-10-10-10z",
      },
    ],
    description:
      "The Public Dashboard of the Research Management Information System provides an accessible platform for users to explore and view research projects from various campuses. It showcases key metrics, interactive data visualizations, and Sustainable Development Goals (SDGs) alignment, offering insights into diverse research initiatives.",
  },
  {
    id: 2,
    title: "Ligtas App",
    ...
    comingSoon: false,
    description:
      "The Ligtas App is a mobile and web-based platform designed to enhance community safety and disaster preparedness. It provides real-time alerts, location-based safety tips, and emergency resources to help users stay informed and respond effectively during emergencies. The app integrates user-friendly navigation, geolocation services, and communication tools to connect users with local authorities and support networks.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    imgSrc: "/Personal-Portfolio/Fitly.jpg", // Replace with your actual image path
